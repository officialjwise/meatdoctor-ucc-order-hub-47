...
const Index = () => {
  ...
  useEffect(() => {
    ...
    if (settings) {
      setBackgroundImage(settings.bgImageUrl);
      setSiteInfo({
  ...
  return (
    <div className="min-h-screen flex flex-col relative">
      ...
      <div 
        ...
        style={{ 
          backgroundImage: backgroundImage ? `url(${backgroundImage})` : 'url(https://images.unsplash.com/photo-1561758033-d89a9ad46330?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1770&q=80)',
          zIndex: -2 
        }}
      />
      <div 
