...
const Index = () => {
  ...
  const handleOrderSearch = (e: React.FormEvent) => {
    e.preventDefault();
    if (!orderId.trim()) {
      showErrorAlert('Input Required', 'Please enter an Order ID');
      return;
    }
    ...
    if (booking) {
      ...
      showSuccessAlert('Order Found', 'Your order details have been retrieved.');
    } else {
      showErrorAlert('Order Not Found', 'Please check the Order ID and try again.');
    ...
    >
      <div className="w-full max-w-6xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row gap-6">
          ...
          {/* Order Tracking & Contact - Now in a flex column layout to avoid overlap */}
